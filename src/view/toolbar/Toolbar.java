...
/**
 * Toolbar for the SLogo Program.
 * Creates and arranges items to manipulate display options.
 *  
 * @author lien
 *
 */
public class Toolbar extends Group {
	...
	private TurtleWindow myTurtleWindow; //bound TurtleWindow where changes are effected
